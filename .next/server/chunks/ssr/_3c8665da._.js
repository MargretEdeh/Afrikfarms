    ...
    const handleFileUpload = async (field, file)=>{
        ...
        try {
            ...
            if (field === "passportPhoto") {
                ...
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$lga$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LGAService"].uploadProfileImage(uploadFormData);
                ...
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$lga$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LGAService"].UploadProofOfAddress(uploadFormData);
                // Fixed: Access image_url from response
                const imageUrl = response?.data?.image_url || response?.image_url;
                handleInputChange(field, imageUrl);
            }
