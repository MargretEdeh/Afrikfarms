...
const apiClient = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: ("TURBOPACK compile-time value", "http://localhost:9000/api/v1"),
    headers: {
...
function setCookie(name, value) {
    ...
    const sameSite = 'Lax';
    const secure = "object" !== 'undefined' && window.location.protocol === 'https:' ? '; Secure' : '';
    document.cookie = "".concat(name, "=").concat(encodeURIComponent(value), "; expires=").concat(expires, "; path=/; SameSite=").concat(sameSite).concat(secure);
}
...
function deleteCookie(name) {
    ...
    const sameSite = 'Lax';
    const secure = "object" !== 'undefined' && window.location.protocol === 'https:' ? '; Secure' : '';
    document.cookie = "".concat(name, "=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; SameSite=").concat(sameSite).concat(secure);
}
...
const AuthProvider = (param)=>{
    ...
    const logout = async ()=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthService"].logout();
        } catch (err) {
...
const LGAService = {
    ...
    uploadProfileImage: async (data, onUploadProgress)=>{
    ...
    UploadProofOfAddress: async (data, onUploadProgress)=>{
    ...
    getAccountName: async (params)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/get-account-name", {
            params: {
...
//# sourceMappingURL=_a264c21d._.js.map